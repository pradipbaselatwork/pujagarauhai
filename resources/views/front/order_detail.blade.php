...
<section class="breadCrumbNav-banner subpage-slider showcase">
  ...
  <div class="shopping-cart my-5">
    ...
    <thead class="column-labels">
      ...
      <th><label class="product-details">Payment Method</label></th>
      <th><label class="product-details">Email</label></th>
      <th><label class="product-details">Status</label></th>
      {{-- <th><label class="product-price">Price</label></th> --}}
      <th><label class="product-line-price">Total Price</label></th>
      <th><label class="product-line-price">See Order</label></th>
   </tr>
  </thead>
  ...
  ?>
      ...
      <td>{{$data->id}}.</td>
          ...
          <td>
            <div class="product-details">
              <div class="product-title">{{$data->payment_method}}</div>
            </div>
            </td>
            
            <td>
                <div class="product-details">
                  <div class="product-title">{{$data->email}}</div>
                </div>
                </td>

                <td>
                  <div class="product-details">
                    <div class="product-title">{{$data->status}}</div>
                  </div>
                  </td>

          <td> <div class="">{{$data->total}}</div></td>   
          <td> <a href="{{ route('seeorderdetail',$data->id )}}"><div class="">Show Order</div></a></td>   
...
?>
    ...
    <div class="totals">
      ...
      <div class="totals-item">
        <label></label>
        {{-- <a href=""><div><b>See Order Details</b></div></a> --}}
      </div>
