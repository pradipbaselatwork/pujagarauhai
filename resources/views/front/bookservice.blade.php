          ...
          <div class="row">
            ...
            <div class="col col-sm-6">
              <div class="form-group">
                ...
                <input id="title" class="form-control" type="text" value="{{ $service->title }}" name="title" required="" placeholder="Service Name">
                <input id="title" class="form-control" type="hidden" value="{{ $service->id }}">
              </div>
