        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
             ...
             {{-- <a href="{{route('admin.add.edit.banner')}}" style="max-width: 150px; float:right; display:inline-block;" class="btn btn-block btn-success"><i class="fa fa-plus-circle" aria-hidden="true"></i>&nbsp;&nbsp;Add All Banner</a> --}}
            </div>
            <div class="card-body">
